...
echo "  Auto-scheduled via cron: Sat & Sun at 18:00 UTC (8h window)"
echo "  Manual: python3 modules/_13_live_wire.py --auto"
echo "  Test scrape: python3 modules/_13_live_wire.py --once --force"
echo "  Preflight: python3 tools/healthcheck.py"
echo ""
echo "=============================================="
